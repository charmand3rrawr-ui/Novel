...
The stage runs from a room to a star system. The engine only ever brings one
rung forward at a time, and only when the storyline reaches for it.

## The ladder

| Tier | Example in this novel | Unlocked by |
|---|---|---|
| room | an examination hall, a records vault | always available |
| building | the Ledgerhouse counting floor | A2 |
| campus | Thorn Ledger, the academy | A1 |
| district | the Quay wards, the Warren | A2 |
| city | Strand Cross, the chartered capital | A2 |
| region | the border reaches, upriver | A3 |
| country | the Charter Union | A3 |
| planet | Anselm, the homeworld | A3 |
| orbital | Pale Verge Station, the transfer chokepoint | A3 |
| moon | Cinder Landing, extraction settlement | A4 |
| planet (frontier) | Harrow Reach, unmetered water | A5 |
| system | the Anselm system and its two partners | background only |

**The rule of scale:** each rung up must cost the protagonist something on a
